...
const promptText = document.querySelector("#section-prompt");
const taskText = document.querySelector("#section-task");
const response = document.querySelector("#section-response");
const answerButton = document.querySelector("#section-answer-button");
const nextButton = document.querySelector("#section-next-button");
